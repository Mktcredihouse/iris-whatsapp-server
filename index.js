  ...
  sock.ev.on('messages.upsert', async ({ messages }) => {
    ...
    try {
      ...
      const webhookPayload = {
        ...
        type,
        media: mediaBase64,
        fromMe: false  // ✅ Sempre false porque já filtramos acima
      }

      console.log(`🔔 [${EMPRESA_ID}] Payload webhook:`, JSON.stringify(webhookPayload, null, 2))
      ...
      if (response.ok) {
        ...
        console.log(`📨 [${EMPRESA_ID}] Webhook OK:`, responseData)
      } else {
